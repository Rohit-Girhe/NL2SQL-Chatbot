...
class SecureSqliteRunner(SqliteRunner):
    """
    A custom wrapper around Vanna's SqliteRunner.
    Intercepts and validates all SQL queries generated by the AI 
    ...
    def run_sql(self, sql: str):
        ...
        # If validation passes, execute using the parent class
